...
[呼叫 tool] convert_unit({"value":",","from_unit":"C","to_unit":"F"})
25°C = 77°F。

計算：F = C × 9/5 + 32 = 25 × 9/5 + 32 = 45 + 32 = 77。
...
[呼叫 tool] convert_unit({"value":"100","from_unit":"公里","to_unit":"英里"})
100 公里約等於 62.1371 英里（約 62.14 英里）。  
...
[呼叫 tool] convert_unit({"value":"80.0","from_unit":"kg","to_unit":"lb"})

[呼叫 tool] convert_unit({"value":"80","from_unit":"kg","to_unit":"lb"})

[呼叫 tool] convert_unit({"value":"80.0","from_unit":"kg","to_unit":"lb"})

[呼叫 tool] convert_unit({"value":"","from_unit":"kg","to_unit":"lb"})
80 公斤 ≈ 176.37 磅。  
（換算係數：1 公斤 ≈ 2.20462262185 磅；80 × 2.20462262185 = 176.369809748）
